...
BASE_IMAGE ?= registry.access.redhat.com/ubi9/ubi-minimal:9.8-1785906621
...
# Example: make generate-rpm-lockfile BASE_IMAGE=registry.access.redhat.com/ubi9/ubi-minimal:9.8-1785906621
