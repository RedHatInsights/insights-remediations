...
exports.up = async q => {
    ...
    const playbook_run_executors = await q.bulkInsert('playbook_run_executors', [{
        ...
        '#\n' +
        '# FiFI playbook 3\n' +
        '# https://console.redhat.com/insights/remediations/249f142c-2ae3-4c3f-b2ec-c8c5881f8561\n' +
        ...
        id: '67d0ba73-0015-4e7d-a6d6-4b530cbfb9bd',
        executor_id: '78c0ba73-1015-4e7d-a6d6-4b530cbfb9bd',
        executor_name: 'executor-6',
        receptor_node_id: 'Job-6',
        receptor_job_id: null,
        status: 'success',
        updated_at: '2019-12-23T08:20:36.641Z',
        ...
        '      command: insights-client\n' +
        '      changed_when: false',
        playbook_run_id: playbook_runs[6].id,
        text_update_full: true
    }], opts);
    ...
    await q.bulkInsert('playbook_run_systems', [{
        ...
        id: '09ce0d48-8f24-40f5-b4e7-f51dda7d18da',
        system_id: '381c8b75-6d07-478e-873f-ed5291da7b9d',
        system_name: 'system-6',
        status: 'success',
        sequence: 272,
        console: 'These are the logs for console-8',
        updated_at: '2019-12-23T18:19:36.641Z',
        playbook_run_executor_id: playbook_run_executors[8].id
    }], opts);
};
