...
const ERRATUM_PATTERN = /^(RH[SBE]A-20[\d]{2}:[\d]{4,6})|(FEDORA-EPEL-[\w-]+)/;
...
exports.getIssueDetails = function (req, id) {
    return getHandler(id, req).getIssueDetails(req, id);
};

exports.getPlayFactory = function (req, id) {
    return getHandler(id, req).getPlayFactory(id);
};
