...
describe('inventory impl', function () {
    ...
    describe('getSystemInfoBatch', function () {
        test('returns expected data', async function () {
            const EXPECTED_PROPS = ['id', 'display_name', 'hostname', 'ansible_host', 'facts',
                'satelliteId', 'satelliteOrgId', 'rhc_client', 'marketplace', 'satelliteManaged']; // TODO: remove facts, satelliteVersion?
