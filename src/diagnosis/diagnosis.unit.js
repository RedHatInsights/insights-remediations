...
describe('/diagnosis', function () {
    test('returns all details information for the given system', async () => {
        ...
        body.details.should.have.size(2);
        body.details.should.have.key('CVE_2018_1111_dhcp|ERROR_CVE_2018_1111_DHCP_2');
        body.details.should.have.key('CVE_2017_5753_4_cpu_kernel|KERNEL_CVE_2017_5753_4_CPU_ERROR_3');
    });
    ...
    test('returns diagnosis information with remediation hint', async () => {
        ...
        .expect(200);
        body.should.have.key('details');
        body.details.should.have.size(1);
        body.details.should.have.key('CVE_2018_1111_dhcp|ERROR_CVE_2018_1111_DHCP_2');
    });
});
