    ...
    describe('playbook run', function () {
        describe('GET', function () {
            ...
            test('playbook_runs/:playbook_run_id/systems', async () => {
                ...
                body.data[0].should.have.property('id', 'c35e6a09-520f-4326-85bd-aaf595b822c5');
                ...
                body.data[1].should.have.property('id', 'efe54a46-9b23-478e-977c-a5553742e725');
                ...
                body.data[2].should.have.property('id', 'a8c4bbeb-dbcf-4fdb-94bc-19e45e961cb1');
            ...
            test('playbook_runs/:playbook_run_id/systems/:system', async () => {
                const {body, text} = await request
                .get('/v1/remediations/249f142c-2ae3-4c3f-b2ec-c8c5881f8561/playbook_runs/88d0ba73-0015-4e7d-a6d6-4b530cbfb5bc/systems/a8c4bbeb-dbcf-4fdb-94bc-19e45e961cb1')
                .set(auth.fifi)
                .expect(200);

                body.should.have.property('id', 'a8c4bbeb-dbcf-4fdb-94bc-19e45e961cb1');
            ...
            test('400 on bad remediationID playbook_runs/:playbook_run_id/systems/:system', async () => {
                await request
                .set(auth.fifi)
                .get('/v1/remediations/249f142c-2aeec-c8c5881f8111/playbook_runs/88d0ba73-0015-4e7d-a6d6-4b530cbfb5bc/systems/a8c4bbeb-dbcf-4fdb-94bc-19e45e961cb1')
                .expect(400);
            });
            ...
            test('400 on bad playbookRunId playbook_runs/:playbook_run_id/systems/:system', async () => {
                await request
                .set(auth.fifi)
                .get('/v1/remediations/249f142c-2ae3-4c3f-b2ec-c8c5881f8561/playbook_runs/88d0ba73-0015-4e6-4b530cbfb111/systems/a8c4bbeb-dbcf-4fdb-94bc-19e45e961cb1')
                .expect(400);
            });
            ...
            test('sets etag for playbook_run/:playbook_run_id/systems/:system', async () => {
                ...
                headers.etag.should.equal('"123-NYmLWOBThQYVGmfa1nTBV7wRDj4"');
            });

            test('304 on etag match for playbook_run/:playbook_run_id/systems/:system', async () => {
                await request
                .get('/v1/remediations/249f142c-2ae3-4c3f-b2ec-c8c5881f8561/playbook_runs/88d0ba73-0015-4e7d-a6d6-4b530cbfb5bc/systems/a8c4bbeb-dbcf-4fdb-94bc-19e45e961cb1')
                .set('if-none-match', '"123-NYmLWOBThQYVGmfa1nTBV7wRDj4"')
                .expect(304);
            });
        });
